...
class CreateHabitActivity : AppCompatActivity() {
    ...
    fun storeHabit(view: View) {
        if(et_title.isBlank() || et_description.isBlank()){
            ...
            displayErrorMessage("Add a motivating picture to your habits.")
            return
        }
        ...
        if(id == -1L){
            displayErrorMessage("Habit could not be stored...let's not make this habit.")
        }else{
    ...
    //this is for better conciseness; this makes the code more readable, clean and robust
    private fun EditText.isBlank() = this.text.toString().isBlank() //this is an extension function that replaces -> et_title.text.toString().isBlank()
